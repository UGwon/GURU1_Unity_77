...
public class GameManager : MonoBehaviour
{
    ...
    {
        if (ScoreManager.Instance.currentScore > 1000 && ScoreManager.Instance.currentScore < 1999)
        {
            background1.SetActive(false);
            background2.SetActive(true);
        }
        if (ScoreManager.Instance.currentScore > 2000 && ScoreManager.Instance.currentScore < 3999 )
        {
            background2.SetActive(false);
            background3.SetActive(true);
        }
        if (ScoreManager.Instance.currentScore > 4000)
        {
