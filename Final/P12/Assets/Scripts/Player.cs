...
public class Player : MonoBehaviour
{
    ...
    public AudioClip rainbowClip; // 무지개 획득 소리
    ...
    {
        itemAudio.PlayOneShot(sunClip); // 해 효과음 재생
        Debug.Log("해 획득 효과음 재생");
    }

    public void RainbowSound()
    {
        itemAudio.PlayOneShot(rainbowClip); // 무지개 효과음 재생
        Debug.Log("무지개 획득 효과음 재생");
    }
